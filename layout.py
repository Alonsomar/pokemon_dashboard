        ...
        children=[
            dbc.Container(
                [
                    ...
                    html.Button(
                        html.I(className="fas fa-moon"), id="theme-switch", className="theme-switch"
                    ),
                    html.Div(
                        id="p5-container",
                        style={
                                    ...
                                    dbc.Nav(
                                        [
                                            ...
                                            html.Div(
                                                [
                                                    html.Span(
                                                        "Alonso Valdés ", className="author-name"
                                                    ),
                                                    html.A(
                                ...
                                [
                                    ...
                                    dbc.CardBody(
                                        [
                                            ...
                                            html.Img(
                                                id="pokemon-image-1", className="pokemon-image"
                                            ),
                                            html.Div(
                                                id="pokemon-info-1",
                                                className="pokemon-info",
                                                style={},
                                            ),  # Ensure style is an empty dict by default
                                        ]
                                    ),
                                ],
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                [
                                    html.Div(
                                        "Pokémon Radar Chart Comparison", className="card-header"
                                    ),
                                    dbc.CardBody(
                                        [
                                            dcc.Loading(
                                ...
                                [
                                    ...
                                    dbc.CardBody(
                                        [
                                            ...
                                            html.Img(
                                                id="pokemon-image-2", className="pokemon-image"
                                            ),
                                            html.Div(
                                                id="pokemon-info-2",
                                                className="pokemon-info",
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                [
                                    html.Div(
                                        "Scatter Plot of Pokémon Stats", className="card-header"
                                    ),
                                    dbc.CardBody(
                                        [
                                            dcc.Loading(
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                [
                                    html.Div(
                                        "Violin Plot of Pokémon Stats by Type 1",
